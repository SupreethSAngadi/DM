...
# Fitting classifier to the Training set and predict the test results
...
regressor= lm(formula = Purchased~.,
              data=training_Set)
summary(regressor)
...
plot(training_set$EstimatedSalary,training_set$Purchased)
